...
<head>
  ...
  <title>Contact Us - PowerHouse Gym</title>
  <style>
    * {
      margin: 0;
      padding: 0;
  ...
  <header>
    ...
    <nav class="navbar">
      <ul>
        ...
        <li><a href="membership22.php">Membership</a></li>
        <li><a href="trainers.html">Trainers</a></li>
        <li><a href="gallery.html">Gallery</a></li>
        <li><a href="contact.php">Contact Us</a></li>
        <li><a href="reviews.html">Review</a></li>
        <li><a href="signin222.php" class="login-btn">Login</a></li>
      </ul>
    </nav>
  </header>
  ...
  <section class="contact-section">
    ...
    <div class="contact-container">
      ...
      <div class="contact-info">
        <h2>Our Address</h2>
        <p>PowerHouse Gym</p>
        <p>Dungri, Near Ramji mandir,Valsad, Gujarat</p>
        <p>Email: powerhousegym@gmail.com</p>
        <p>Phone: +91 9898 683867</p>
        <p>Hours: Mon - Sat: 5am – 10pm</p>
      </div>
